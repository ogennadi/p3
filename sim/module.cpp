...
void print_id (const char *str, ModuleID mid)
{
    ...
    case NI_M: fprintf (stdout, "%4s:%3d/NI  ", str, mid.nodeID); break;
    case PR_M: fprintf (stdout, "%4s:%3d/PR  ", str, mid.nodeID); break;
    case L1_M: fprintf (stdout, "%4s:%3d/L1  ", str, mid.nodeID); break;
    case L2_M: fprintf (stdout, "%4s:%3d/L2  ", str, mid.nodeID); break;
    case L3_M: fprintf (stdout, "%4s:%3d/L3  ", str, mid.nodeID); break;
    case MC_M: fprintf (stdout, "%4s:%3d/MC  ", str, mid.nodeID); break;
    case INVALID_M:  fprintf (stdout, "%4s:  None ", str); break;
    }
}
